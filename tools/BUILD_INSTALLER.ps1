...
foreach ($f in @('app_paths.py','application_status_agent.py','company_watch.py','cv_engine.py','cv_prompt.py','excel_export.py','free_job_sources.py','gmail.py','jobs.py','job_monitor.py','linkedin_browser.py','messaging.py','notifications.py','presence.py','storage.py','ai_cv_generation_prompt.txt')) {
