...
st.markdown(
    ...
    */
    ...
    .jobsync-network{position:absolute;inset:72px 20px 25px;min-height:200px;}
    ...
    div:has(>.jobsync-sector-grid-marker){border:1px solid rgba(91,139,236,.18);border-radius:22px;padding:16px;margin:18px 0 0;background:linear-gradient(145deg,rgba(9,17,34,.95),rgba(12,15,36,.95));box-shadow:0 18px 45px rgba(0,0,0,.2);}
    ...
    div:has(>.jobsync-sector-grid-marker) .stButton > button{position:relative;overflow:hidden;min-height:96px;width:100%;padding:14px 12px 12px;border-radius:17px;background:rgba(8,16,33,.9);border:1px solid rgba(95,151,255,.25);box-shadow:0 12px 30px rgba(0,0,0,.25),inset 0 1px 0 rgba(255,255,255,.035);transition:transform .2s ease,border-color .2s ease,box-shadow .2s ease;display:flex;flex-direction:column;align-items:flex-start;justify-content:center;gap:2px;white-space:pre-line;text-align:left;}
    ...
    div:has(>.jobsync-sector-grid-marker) .stButton > button p{margin:0;color:#94a8c4;font-size:.62rem;font-weight:600;white-space:pre-line;line-height:1.55;}
    div:has(>.jobsync-sector-grid-marker) .stButton > button p:first-line{color:#edf5ff;font-size:.8rem;font-weight:850;}
    ...
    .jobsync-neural-card{min-height:clamp(220px,24vh,300px);}
    ...
    .jobsync-neural-core{width:128px;height:128px;z-index:8;background:radial-gradient(circle at 50% 30%,rgba(73,174,255,.40),rgba(8,17,39,.97) 58%,rgba(10,10,30,.99));}
    ...
    .jobsync-logo-mark{position:relative;z-index:2;width:52px;height:46px;gap:4px;}
    .jobsync-logo-mark i{width:8px;border-radius:9px 9px 4px 4px;box-shadow:0 0 9px rgba(65,210,255,.12);transform-origin:bottom center;}
