...
st.markdown(
    ...
    */
    ...
    .jobsync-home-shell{width:100%;max-width:1280px;margin:0 auto;padding:10px 0 34px;}
                    .jobsync-home-greeting-top{text-align:left;margin:0 0 18px;padding:0 2px;}
    .jobsync-home-greeting-kicker{font-size:.62rem;font-weight:950;letter-spacing:.2em;color:#54ddff;margin-bottom:8px}.jobsync-home-greeting-title{font-size:clamp(2.35rem,5vw,4.65rem);line-height:.98;font-weight:950;letter-spacing:-.065em;background:linear-gradient(90deg,#dff7ff 0%,#8fdcff 38%,#b99cff 72%,#d47cff 100%);-webkit-background-clip:text;background-clip:text;color:transparent;animation:jobsync-home-fade .7s ease both}.jobsync-home-greeting-subtitle{margin-top:10px;color:#8795aa;font-size:clamp(.78rem,1.3vw,1rem);animation:jobsync-home-fade .7s ease .08s both;}
    .jobsync-home-command-grid{display:grid;grid-template-columns:minmax(0,1fr) 350px;gap:18px;align-items:stretch;}
    .jobsync-neural-card{position:relative;min-height:650px;overflow:hidden;border:1px solid rgba(91,139,236,.2);border-radius:28px;background:radial-gradient(circle at 50% 48%,rgba(40,83,155,.18),transparent 30%),linear-gradient(145deg,rgba(5,13,27,.98),rgba(9,14,31,.96) 55%,rgba(20,10,43,.98));box-shadow:0 25px 70px rgba(0,0,0,.28),inset 0 1px 0 rgba(255,255,255,.025);}
    ...
    .jobsync-neural-head{position:absolute;top:22px;left:24px;z-index:8}.jobsync-neural-kicker{font-size:.58rem;font-weight:950;letter-spacing:.18em;color:#6f819c}.jobsync-neural-title{font-size:1.05rem;font-weight:850;color:#eaf2ff;margin-top:5px}.jobsync-neural-sub{font-size:.63rem;color:#697991;margin-top:3px;}
    .jobsync-network{position:absolute;inset:72px 20px 25px;min-height:550px;}
    ...
    .jobsync-neural-core{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);z-index:6;width:148px;height:148px;border-radius:50%;display:grid;place-items:center;text-align:center;background:radial-gradient(circle at 50% 35%,rgba(72,153,255,.34),rgba(9,18,42,.98) 62%);border:1px solid rgba(78,220,255,.55);box-shadow:0 0 0 10px rgba(75,137,255,.035),0 0 55px rgba(67,170,255,.25),inset 0 0 35px rgba(80,93,255,.18);animation:jobsync-core-glow 4s ease-in-out infinite;}
    .jobsync-logo-mark{width:57px;height:57px;display:flex;align-items:flex-end;justify-content:center;gap:4px;margin:auto auto 5px;filter:drop-shadow(0 0 15px rgba(65,205,255,.42));}.jobsync-logo-mark i{display:block;width:9px;border-radius:8px 8px 3px 3px;background:linear-gradient(180deg,#4be9ff,#4d7bff);animation:jobsync-bar 2.4s ease-in-out infinite}.jobsync-logo-mark i:nth-child(1){height:28px}.jobsync-logo-mark i:nth-child(2){height:42px;background:linear-gradient(180deg,#39e8ff,#7b5dff);animation-delay:.15s}.jobsync-logo-mark i:nth-child(3){height:35px;background:linear-gradient(180deg,#7f7bff,#c14eff);animation-delay:.3s}.jobsync-logo-mark i:nth-child(4){height:24px;background:linear-gradient(180deg,#f36cff,#ff5b9e);animation-delay:.45s}.jobsync-core-name{color:#fff;font-size:1.02rem;font-weight:950;letter-spacing:-.035em}.jobsync-core-sub{color:#8ea5c4;font-size:.51rem;margin-top:2px;}
    .jobsync-sector{position:absolute;z-index:7;width:156px;padding:12px 14px;border-radius:17px;background:rgba(8,16,33,.9);border:1px solid rgba(95,151,255,.25);box-shadow:0 12px 30px rgba(0,0,0,.25),inset 0 1px 0 rgba(255,255,255,.035);transition:transform .2s ease,border-color .2s ease,box-shadow .2s ease;cursor:pointer;backdrop-filter:blur(10px)}.jobsync-sector:hover{transform:translateY(-3px) scale(1.015);border-color:rgba(80,213,255,.55);box-shadow:0 18px 35px rgba(0,0,0,.35),0 0 22px rgba(61,180,255,.1)}.jobsync-sector summary{list-style:none;outline:none}.jobsync-sector summary::-webkit-details-marker{display:none}.jobsync-sector .sector-name{display:block;color:#edf5ff;font-size:.76rem;font-weight:850}.jobsync-sector .sector-count{display:block;color:#94a8c4;font-size:.62rem;margin-top:4px}.jobsync-sector .sector-state{display:inline-flex;margin-top:7px;padding:3px 7px;border-radius:999px;font-size:.5rem;font-weight:850;color:#7ce7ff;background:rgba(70,210,255,.07);border:1px solid rgba(70,210,255,.15)}.jobsync-sector[open]{border-color:rgba(180,102,255,.55)}.jobsync-sector p{margin:8px 0 0;color:#8393aa;font-size:.56rem;line-height:1.45}.jobsync-sector.s1{left:5%;top:13%}.jobsync-sector.s2{right:5%;top:13%}.jobsync-sector.s3{left:0;top:45%}.jobsync-sector.s4{right:0;top:45%}.jobsync-sector.s5{left:9%;bottom:9%}.jobsync-sector.s6{right:9%;bottom:9%}.jobsync-sector.s7{left:50%;bottom:6%;transform:translateX(-50%)}.jobsync-sector.s8{left:50%;right:auto;top:2%;transform:translateX(-50%)}
    .jobsync-home-rail{display:flex;flex-direction:column;gap:18px}.jobsync-home-panel{border:1px solid rgba(91,139,236,.18);border-radius:22px;background:linear-gradient(145deg,rgba(9,17,34,.95),rgba(12,15,36,.95));box-shadow:0 18px 45px rgba(0,0,0,.2);overflow:hidden}.jobsync-panel-head{padding:17px 18px 13px;border-bottom:1px solid rgba(255,255,255,.055)}.jobsync-panel-title{font-size:.92rem;font-weight:850;color:#edf4ff}.jobsync-panel-sub{font-size:.58rem;color:#6e7e95;margin-top:4px}.jobsync-progress{padding:13px 18px 17px}.jobsync-progress-row{display:grid;grid-template-columns:26px 1fr auto;gap:9px;align-items:center;padding:8px 0}.jobsync-progress-dot{width:24px;height:24px;border-radius:50%;display:grid;place-items:center;font-size:.58rem;font-weight:900;border:1px solid rgba(130,150,190,.28);color:#8392aa}.jobsync-progress-row.done .jobsync-progress-dot{color:#06170f;background:linear-gradient(145deg,#66f0b0,#35d88e);border-color:#54e7a1;box-shadow:0 0 15px rgba(56,230,145,.2)}.jobsync-progress-label{color:#e5edf8;font-size:.65rem;font-weight:800}.jobsync-progress-state{color:#718199;font-size:.53rem;margin-top:2px}.jobsync-progress-value{color:#9edfff;font-size:.55rem;font-weight:800}.jobsync-insights{padding:8px 18px 16px}.jobsync-insight{display:flex;align-items:center;gap:10px;padding:10px 0;border-bottom:1px solid rgba(255,255,255,.045)}.jobsync-insight:last-child{border-bottom:0}.jobsync-insight-icon{width:30px;height:30px;border-radius:10px;display:grid;place-items:center;background:rgba(72,170,255,.1);color:#6ee7ff;font-size:.8rem}.jobsync-insight b{display:block;color:#edf4ff;font-size:.66rem}.jobsync-insight span{display:block;color:#718198;font-size:.53rem;margin-top:2px}.jobsync-insight strong{margin-left:auto;color:#7cebb4;font-size:.6rem}
    .jobsync-home-actions{margin-top:18px;border:1px solid rgba(91,139,236,.18);border-radius:22px;padding:16px;background:rgba(7,14,29,.72);}.jobsync-home-actions-title{color:#edf4ff;font-size:.9rem;font-weight:850}.jobsync-home-actions-sub{color:#6e7e95;font-size:.58rem;margin-top:3px}.jobsync-home-action-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin-top:13px}.jobsync-action-card{padding:13px;border:1px solid rgba(94,139,255,.16);border-radius:15px;background:linear-gradient(145deg,rgba(18,30,56,.8),rgba(12,17,34,.9));transition:.2s ease}.jobsync-action-card:hover{transform:translateY(-2px);border-color:rgba(77,211,255,.4);box-shadow:0 10px 25px rgba(0,0,0,.2)}.jobsync-action-icon{font-size:1rem;color:#61dcff}.jobsync-action-title{color:#edf4ff;font-size:.67rem;font-weight:850;margin-top:8px}.jobsync-action-sub{color:#718199;font-size:.51rem;margin-top:3px}.jobsync-home-online-inline{margin-bottom:0}
    ...
    @media(prefers-reduced-motion:reduce){.jobsync-neural-card:before,.jobsync-network path,.jobsync-network circle,.jobsync-neural-core,.jobsync-logo-mark i,.jobsync-home-greeting-title,.jobsync-home-greeting-subtitle{animation:none!important}.jobsync-sector:hover,.jobsync-action-card:hover{transform:none}}
    @media(max-width:1100px){.jobsync-home-command-grid{grid-template-columns:minmax(0,1fr) 300px}.jobsync-sector{width:142px}.jobsync-home-action-grid{grid-template-columns:repeat(2,1fr)}}
    @media(max-width:850px){.jobsync-home-shell{padding-top:4px}.jobsync-home-user-top{justify-content:flex-start}.jobsync-home-command-grid{grid-template-columns:1fr}.jobsync-neural-card{min-height:600px}.jobsync-home-rail{display:grid;grid-template-columns:1fr 1fr}.jobsync-sector{width:135px}.jobsync-sector.s7{left:50%;bottom:6%;transform:translateX(-50%)}.jobsync-sector.s8{left:50%;right:auto;top:2%;transform:translateX(-50%)}}
    @media(max-width:560px){.jobsync-home-greeting-title{font-size:2.25rem}.jobsync-neural-card{min-height:560px;border-radius:20px}.jobsync-network{inset:70px 8px 15px}.jobsync-neural-core{width:112px;height:112px}.jobsync-logo-mark{transform:scale(.82)}.jobsync-sector{width:112px;padding:9px 10px}.jobsync-sector .sector-name{font-size:.66rem}.jobsync-sector .sector-count{font-size:.53rem}.jobsync-sector.s1{left:1%;top:12%}.jobsync-sector.s2{right:1%;top:12%}.jobsync-sector.s3{left:-2%;top:45%}.jobsync-sector.s4{right:-2%;top:45%}.jobsync-sector.s5{left:2%;bottom:7%}.jobsync-sector.s6{right:2%;bottom:7%}.jobsync-home-rail{grid-template-columns:1fr}.jobsync-home-action-grid{grid-template-columns:1fr 1fr}.jobsync-home-actions{padding:12px}}
    /* v1.7.0 Home refinement: premium neural detail + responsive workspace sizing. */
    .jobsync-neural-card{min-height:clamp(610px,68vh,760px);}
    ...
    .jobsync-neural-core{width:168px;height:168px;z-index:8;background:radial-gradient(circle at 50% 30%,rgba(73,174,255,.40),rgba(8,17,39,.97) 58%,rgba(10,10,30,.99));}
    .jobsync-neural-core:before{content:"";position:absolute;inset:10px;border:1px solid rgba(86,223,255,.18);border-radius:50%;box-shadow:inset 0 0 30px rgba(77,122,255,.12);}
    .jobsync-logo-mark{position:relative;z-index:2;width:64px;height:58px;gap:5px;}
    .jobsync-logo-mark i{width:10px;border-radius:9px 9px 4px 4px;box-shadow:0 0 9px rgba(65,210,255,.12);transform-origin:bottom center;}
    .jobsync-core-name,.jobsync-core-sub{position:relative;z-index:2;}
    .jobsync-sector{z-index:9;min-width:0;}
    .jobsync-sector:after{content:"";position:absolute;right:10px;top:10px;width:5px;height:5px;border-radius:50%;background:#4ee8ff;box-shadow:0 0 9px rgba(78,232,255,.8);opacity:.7;animation:jobsync-node-pulse 2.8s ease-in-out infinite;}
    .jobsync-sector[open]:after{background:#c47aff;}
    .jobsync-sector .sector-name{font-size:.79rem;letter-spacing:-.015em;}
    .jobsync-sector .sector-count{font-size:.65rem;}
    .jobsync-sector .sector-state{font-size:.51rem;}
    .jobsync-sector p{font-size:.57rem;}
    ...
    @media (min-width:1500px){.jobsync-home-shell{max-width:1480px}.jobsync-home-command-grid{grid-template-columns:minmax(0,1fr) 390px}.jobsync-sector{width:174px}.jobsync-neural-card{min-height:700px}}
    @media (max-width:1200px){.jobsync-home-shell{max-width:calc(100vw - 36px)}.jobsync-home-command-grid{grid-template-columns:minmax(0,1fr) 320px}.jobsync-sector{width:148px}.jobsync-neural-card{min-height:620px}}
    @media (max-width:900px){.block-container{padding-left:1rem!important;padding-right:1rem!important}.jobsync-home-shell{max-width:none}.jobsync-home-command-grid{grid-template-columns:1fr}.jobsync-home-rail{display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}.jobsync-neural-card{min-height:620px}.jobsync-sector{width:145px}.jobsync-home-actions{margin-top:14px}.jobsync-home-action-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
    @media (max-width:640px){.jobsync-home-greeting-title{font-size:clamp(2rem,9vw,2.7rem)}.jobsync-neural-card{min-height:590px;border-radius:22px}.jobsync-network{inset:72px 4px 12px}.jobsync-network:before{width:210px;height:210px}.jobsync-network:after{width:330px;height:330px}.jobsync-neural-core{width:128px;height:128px}.jobsync-logo-mark{transform:scale(.86)}.jobsync-sector{width:118px;padding:9px 10px;border-radius:14px}.jobsync-sector .sector-name{font-size:.66rem}.jobsync-sector .sector-count{font-size:.54rem}.jobsync-sector .sector-state{font-size:.45rem}.jobsync-sector p{font-size:.50rem}.jobsync-sector.s1{left:0;top:10%}.jobsync-sector.s2{right:0;top:10%}.jobsync-sector.s3{left:-1%;top:42%}.jobsync-sector.s4{right:-1%;top:42%}.jobsync-sector.s5{left:1%;bottom:8%}.jobsync-sector.s6{right:1%;bottom:8%}.jobsync-sector.s7{left:50%;bottom:6%;transform:translateX(-50%)}.jobsync-sector.s8{left:50%;right:auto;top:2%;transform:translateX(-50%)}.jobsync-home-rail{grid-template-columns:1fr}.jobsync-home-action-grid{grid-template-columns:1fr}.jobsync-home-actions{padding:12px}}
    @media (prefers-reduced-motion:reduce){.jobsync-neural-card:before,.jobsync-neural-card:after,.jobsync-network:before,.jobsync-network:after,.jobsync-network path,.jobsync-network circle,.jobsync-neural-core,.jobsync-logo-mark i,.jobsync-sector:after{animation:none!important}}
...
def _render_home_authenticated_content():
    ...
    positions=["s1","s2","s3","s4","s5","s6","s7","s8"]
    colors=["","p2","p3","p2","p3","","p2","p3"]
    nodes=[]
    for idx,(name,count,status,matches) in enumerate(sector_data[:8]):
        pos=positions[idx]; cls=colors[idx]
        sample=html.escape(str((matches[0].get("title") if matches else "No current listings") or "No current listings"))[:70]
        desc=f"{count} matching jobs in this sector. Example: {sample}."
        nodes.append(f'<details class="jobsync-sector {pos}"><summary><span class="sector-name">{html.escape(name)}</span><span class="sector-count">{count:,} jobs</span><span class="sector-state">{html.escape(status)}</span></summary><p>{html.escape(desc)}</p></details>')
    node_html="".join(nodes)
    # SVG paths are visual only; actual values are rendered from existing data in the nodes.
...
# ---------------- CV & COVER LETTER ----------------
    ...
    if not prompt_ready and wizard_step == 1:
        ...
        if status == "prompt_generated":
            ...
            st.code(latex_source or "% No LaTeX source is available.", language="latex", wrap_lines=True, height=250)
            st.markdown('<div class="cvwiz-source-help">Use the copy icon on the code frame. The code frame is the handoff point: copy the LaTeX, then use Continue to Overleaf to sign in.</div>', unsafe_allow_html=True)
